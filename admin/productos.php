    ...
    <div class="col-md-12">
        <div class="table-responsive">
            <table class="table table-hover table-bordered" style="width: 100%;">
                ...
                <tbody>
                    <?php
                    $query = mysqli_query($conexion, "SELECT p.*, c.codigo  AS codigo_cat, c.categoria FROM productos p INNER JOIN categorias c ON c.codigo = p.idcategoria ORDER BY p.codigo DESC");
                    while ($data = mysqli_fetch_assoc($query)) { ?>
                        <tr>
                            ...
                            <td>
                                <form method="post" action="eliminar.php?accion=pro&codigo=<?php echo $data['codigo']; ?>" class="d-inline eliminar">
